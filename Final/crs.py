...
if static_intruder:
        ...
        for runs in range(100):
            ...
            while not search_state: #   While Intruder is not found
                ...
                if all_reached:
                    ...
                    robots = matching(bipartite,robots,next_locs,grid_graph,maxi=1)
    ...
    # fileObject = open(path_+'/results_7s_5g_10lg/2_MRIS_b_s_crs_maxi', 'wb')
...
if dynamic_intruder:
    ...
    #     agents.append(num_robots)   #   Store number of robots utilized for search of static intruder
    #     data.append(data_run)
    # fileObject = open(path_+'/results_7s_5g_10lg/2_MRIS_b_d_crs_maxi', 'wb')
    # pkl.dump(np.array(data),fileObject)
    # # pkl.dump(np.array(agents),fileObject)
    # fileObject.close()
